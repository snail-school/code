...
void z_1(),z_2(),z_3(),z_4(),z_5(),g_6(),z_7(),g_8();//경매 스탯/호감도
void p()
{
    printf("\n\n\t\t\t\t^@\n\n");
}
...
exerciseStats()
{
    ...
    switch(choice)
    {
        ...
        default:printf("\n다시 입력하세요");system("pause>NULL");system("cls");exerciseStats();
    }
}
examStats()
{
    ...
    switch(choice)
    {
        ...
        default:printf("\n다시 입력하세요\n");system("pause>NULL");system("cls");examStats();break;
    }
}
exerciseHeart()
{
    ...
    switch(choice)
    {
        ...
        default:printf("\n다시 입력하세요\n");system("pause>NULL");system("cls");exerciseHeart();break;
    }
}
examHeart()
{
    ...
    switch(choice)
    {
        ...
        default:printf("\n다시 입력하세요\n");system("pause>NULL");system("cls");exerciseStats();break;
    }
}
gameStats()
{
